...
const resources = {
  en: {
    translation: {
      ...
      "forum.noResults":
        "No daily updates found. Try a different search or filter.",
      "forum.loading": "Loading daily updates...",
      "favorites.empty": "No favorite daily updates yet.",
      "admin.deleteConfirm":
        "Are you sure you want to delete this daily update?",
      "admin.pinned": "Daily update pinned!",
      "admin.unpinned": "Daily update unpinned!",
      "admin.deleted": "Daily update deleted!",
      "services.preacher": "Islamic lectures - public lectures",
      "footer.service8": "Islamic lectures - public lectures",
      "lang.en": "English",
      "lang.ar": "العربية",
      "lang.ha": "Hausa",
      "lang.fr": "Français",
      "lang.eg": "العربية المصرية",
    },
  },
  ar: {
    translation: {
      ...
      "forum.noResults": "لا توجد تحديثات يومية. جرب بحث أو تصفية مختلفة.",
      "forum.loading": "جاري تحميل التحديثات اليومية...",
      "favorites.empty": "لا توجد تحديثات يومية مفضلة بعد.",
      "admin.deleteConfirm": "هل أنت متأكد أنك تريد حذف هذا التحديث اليومي؟",
      "admin.pinned": "تم تثبيت التحديث اليومي!",
      "admin.unpinned": "تم إلغاء تثبيت التحديث اليومي!",
      "admin.deleted": "تم حذف التحديث اليومي!",
      "services.preacher": "محاضرات إسلامية - محاضرات عامة",
      "footer.service8": "محاضرات إسلامية - محاضرات عامة",
      "lang.en": "English",
      "lang.ar": "العربية",
      "lang.ha": "هوسا",
      ...
      "forum.allDailyUpdates": "كل التحديثات اليومية",
      latest_dailyUpdates: "أحدث التحديثات اليومية",
    },
  },
  ha: {
  ...
  fr: {
    translation: {
      ...
      latest_teachings: "Dernières leçons",
      ...
      "forum.noResults": "Aucune mise à jour quotidienne trouvée. Essayez une recherche ou un filtre différent.",
      "forum.loading": "Chargement des mises à jour quotidiennes...",
      "favorites.empty": "Aucune mise à jour quotidienne favorite trouvée.",
      "admin.deleteConfirm": "Êtes-vous sûr de vouloir supprimer cette mise à jour quotidienne ?",
      "admin.pinned": "Mise à jour quotidienne épinglée !",
      "admin.unpinned": "Mise à jour quotidienne désépinglée !",
      "admin.deleted": "Mise à jour quotidienne supprimée !",
      "services.preacher": "Prédicateur / Conférencier islamique",
      "footer.service8": "Prédicateur / Conférencier islamique",
      "lang.en": "Anglais",
      "lang.ar": "Arabe",
      "lang.ha": "Hausa",
      "lang.fr": "Français",
      "lang.eg": "Arabe égyptien",
