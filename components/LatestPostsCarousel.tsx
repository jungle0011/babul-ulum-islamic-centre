    ...
    <section className="max-w-6xl mx-auto py-8 px-2">
      ...
      {modalPost && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-0 py-0" style={{ minHeight: '100vh' }} onClick={() => setModalPost(null)}>
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-full sm:max-w-md md:max-w-lg relative max-h-[90vh] overflow-y-auto overflow-x-hidden p-2 sm:p-8 flex flex-col items-center gap-4 mx-2 my-4 sm:mx-auto" style={{ boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }} onClick={e => e.stopPropagation()}>
